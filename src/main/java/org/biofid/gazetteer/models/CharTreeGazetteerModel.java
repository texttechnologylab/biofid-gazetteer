...
public class CharTreeGazetteerModel extends SkipGramGazetteerModel implements ITreeGazetteerModel {
	 ...
	 * @throws IOException
	 */
	public CharTreeGazetteerModel(String[] aSourceLocations, Boolean bUseLowercase, String sLanguage, double dMinLength, boolean bAllSkips, boolean bSplitHyphen, boolean bAddAbbreviatedTaxa) throws IOException {
